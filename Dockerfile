...
ENV ACTIVEMQ_OPTS="-javaagent:jmx_prometheus_javaagent-0.11.0.jar=9779:/opt/amq/conf/promconfig.yml"
RUN curl -L $JOLOKIA_AGENT_URL -o /opt/amq/lib/jmx_prometheus_javaagent-0.11.0.jar